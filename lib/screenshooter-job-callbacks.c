...
void cb_image_ipfs_uploaded (ScreenshooterJob  *job,
                        gchar             *upload_name,
                        gchar            **last_user)
{
  GtkWidget *dialog;
  ...
  title = _("My screenshot on IPFS");
  image_url = g_strdup_printf ("https://ipfs.io/ipfs/%s", upload_name);
  thumbnail_url =
    g_strdup_printf ("https://ipfs.io/ipfs/%s", upload_name);
  small_thumbnail_url =
    g_strdup_printf ("https://ipfs.io/ipfs/%s", upload_name);
